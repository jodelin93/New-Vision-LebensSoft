	   ...
	   <div class="row">
          <div class="nav-tabs-custom" id="tabs">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#tab_1" data-toggle="tab">Employer</a></li>
              <li><a href="#tab_2" data-toggle="tab" id="tabP">Parrains</a></li>
              <li><a href="#tab_3" data-toggle="tab">Parrents</a></li>
              <li><a href="#tab_4" data-toggle="tab">Présence</a></li>
              <li><a href="#tab_5" data-toggle="tab">Cong&eacute;</a></li>
        ...
        <?php } ?>
            ...
            <!-- /.box-body -->
              ...
              <div class="tab-pane" id="tab_3">
               ...
               <?php include("includes/presence.php");  ?>
              </div>
 		...
 		<div id="msgModal" class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" style="display: none;">
					<div class="modal-dialog modal-sm">
						<div class="modal-content">
							...
							<div class="modal-body"> <div id="errrrrrrrrrr"> </div> </div>
						</div>
						<!-- /.modal-content -->
					</div>
					<!-- /.modal-dialog -->
...
<script src="js/ressourceshumaines.js"></script>
<script src="js/index.js"></script>
<!-- ./wrapper -->
<script>
    // $('#myModal').modal('show');
    function nombreHeure(str){
        // alert(str);
        var xmlhttp = new XMLHttpRequest();
        xmlhttp.onreadystatechange = function(){
          if(this.readyState==4 && this.status == 200){
            document.getElementById('nbreHeureId').innerHTML=this.responseText;
          }
        }
        xmlhttp.open("GET", "fonctions/nbreHeure.php?intervalle=" + str, true);
        xmlhttp.send();
      }
