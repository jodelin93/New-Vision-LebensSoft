          ...
          <div class="row">
            ...
            <div class="nav-tabs-custom">
                          ...
                          <div class="tab-content" id="main">
                           ...
                           <form id="empForm" action="" method="post" class="form-element">
                             <fieldset>
                                <div class="col-lg-4">
                                  ...
                                  <br>
                                  <input type="date" id="" name="dat_naiss" class="form-control innodate" placeholder="Date de Naissance" required>
                                  <br>
                                  ...
                                  <br>
                                  <input type="email" id="email_emp" name="email_emp" class="form-control" placeholder="L'e-mail' de l'employer">
                                  <br>
